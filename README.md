# 🚀 Portfólio Profissional - Douglas Henrique
...
Apesar de ser um projeto de portfólio web, utilizei tecnologias modernas e leves para garantir uma boa experiência de leitura e performance:
...
### 1. Foco em Backend (.NET)
Diferente de portfólios comuns, este site destaca a minha experiência com **C#, .NET Core e SQL Server**, detalhando sistemas que desenvolvi e que já estão em produção.
